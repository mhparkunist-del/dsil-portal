...
(function () {
  ...
  function seedData() {
    ...
    return {
      ...
      requests: [
        { id: uid(), createdAt: daysAgo(1), requesterId: 'demo-1', requesterName: '홍길동', item: '6인치 SiO2/Si 웨이퍼 25매', category: 'material', link: 'https://example.com/wafer', qty: 1, unitPrice: 1850000, amount: 1850000, note: 'TMD 성장용 기판', status: 'pending', projectId: null, adminNote: '', processedAt: null, processedBy: null },
        { id: uid(), createdAt: daysAgo(2), requesterId: 'demo-2', requesterName: '이영희', item: 'PDMS 스탬프 세트 (Gel-Pak)', category: 'material', link: '', qty: 3, unitPrice: 120000, amount: 360000, note: '전사 공정용', status: 'pending', projectId: null, adminNote: '', processedAt: null, processedBy: null },
        { id: uid(), createdAt: daysAgo(3), requesterId: 'demo-3', requesterName: '박철수', item: '프로브 스테이션 텅스텐 팁 (10개)', category: 'equipment', link: 'https://example.com/tip', qty: 2, unitPrice: 95000, amount: 190000, note: '', status: 'pending', projectId: null, adminNote: '', processedAt: null, processedBy: null },
        { id: uid(), createdAt: daysAgo(9), requesterId: 'demo-1', requesterName: '홍길동', item: 'HfO2 ALD 전구체 (TDMAH) 25 g', category: 'material', link: '', qty: 1, unitPrice: 2400000, amount: 2400000, note: '', status: 'done', projectId: p2, adminNote: '', processedAt: daysAgo(8), processedBy: '관리자' },
        { id: uid(), createdAt: daysAgo(14), requesterId: 'demo-2', requesterName: '이영희', item: 'Keithley 2636B 케이블/픽스처', category: 'equipment', link: '', qty: 1, unitPrice: 780000, amount: 780000, note: '', status: 'done', projectId: p1, adminNote: '', processedAt: daysAgo(13), processedBy: '관리자' },
        { id: uid(), createdAt: daysAgo(20), requesterId: 'demo-3', requesterName: '박철수', item: 'Cu 필러 범프 시편 가공 외주', category: 'activity', link: '', qty: 1, unitPrice: 4500000, amount: 4500000, note: '패키징 실험용', status: 'done', projectId: p3, adminNote: '', processedAt: daysAgo(19), processedBy: '관리자' },
        { id: uid(), createdAt: daysAgo(25), requesterId: 'demo-1', requesterName: '홍길동', item: '노트북 (개인 사용)', category: 'equipment', link: '', qty: 1, unitPrice: 2100000, amount: 2100000, note: '', status: 'rejected', projectId: null, adminNote: '개인 장비는 과제 예산 집행 불가', processedAt: daysAgo(24), processedBy: '관리자' }
      ]
    };
  }

  /* 이전 버전 데이터(단일 budget, category 없음)를 현재 형태로 맞춤 */
  ...
  function LocalStore(cfg) {
    ...
    return {
      ...
      deleteProject: function (id) {
        ...
        if (used) return Promise.reject(new Error('이미 배정된 구매건이 있는 과제는 삭제할 수 없습니다. 종료 처리하세요.'));
